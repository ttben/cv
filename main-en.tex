...
\name{Benjamin}{Benni}
\title{Ph.D. student in Computer Sciences}                               % optional, remove / comment the line if not wanted
...
\cventry{}{Université Côte d'Azur}{Ph.D. Student in Computer Sciences}{2016-now.}{}{
        \begin{itemize}
            ...
            \item Supervisors : Michel Riveill \& Sébastien Mosser
...
\cventry{}{Polytech Nice - Université de Nice - Sophia-Antipolis}{Engineer in Computer Sciences}{2016}{}{Rank : 2/109, Specialty in software architecture, rank : 1/36}
\vspace{\spacesBetweenCVEntries}
\cventry{}{Université de Nice - Sophia-Antipolis}{Technology degree in Computer Sciences (DUT)}{2013}{}{}
\vspace{\spacesBetweenCVEntries}
\cventry{}{Parc Impérial}{Bachelor's degree in sciences}{2011}{Italian european class}{}
...
\cventry{2016-2019}{Polytech Nice - Sophia-Antipolis}{Teaching assistant}{}{}{
    ...
    \begin{itemize}
        \setlength\itemsep{\spacesBetweenItems}
        \item Creator and instructor of a programming, development tools, and project managment tutoring course. 1 session, 4 hours weekly, 20 students.
...
\newpage
\section{Recherche}
My research interests are software composition and its related scaling issues.
...
In such a context where the operators' definitions and implementation are not known, the contribution was to provide assessments and property-verifications, without knowing our the operators work, in a domain-independant way.
The main approach is to compute modifications operated by a black-box operator, and relies on these to define properties such as conflicts-free situations and termination.
We validated our contribution against real-life use-cases such as the Linux kernel or the Docker ecosystems.
