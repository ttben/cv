...
\quote{4 Mars 2020}                                 % optional, remove / comment the line if not wanted
...
\cventry{}{Université Côte d'Azur}{Docteur en informatique}{2016-2019}{}{
        \begin{itemize}
...
\cventry{2020-auj.}{Université Concordia, Montréal Québec}{Chercheur Post-doctoral}{}{}{
    \vspace{\spacesBetweenCVEntries}
    \begin{itemize}
        \setlength\itemsep{\spacesBetweenItems}
        \item Internet des objets, Projet avec la compagnie Humanitas
        \item Ptidej Team, dirigée par Yann-Gaël Guéhéneuc
    \end{itemize}
}
